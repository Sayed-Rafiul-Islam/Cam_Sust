    ...
    return (
            <div className={navbar ? 'navbar active' : 'navbar'}>
                ...
                <div> 
                    ...
                    <Link prefetch onClick={()=>setVisible(true)} className={visible ? 'cart-ico-1 my-auto cart-ico' : 'cart-ico-2  my-auto cart-ico' } href='/camShop/cart' ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
