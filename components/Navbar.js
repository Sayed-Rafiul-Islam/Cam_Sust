    ...
    return (
            <div className={navbar ? 'navbar active' : 'navbar'}>
                ...
                <div> 
                    ...
                    {
                        user ?
                    <button onClick={logOut} className="lg:border border-red-600 text-red-600 px-4 my-2 lg:mr-5 ml-36 rounded-sm hover:bg-red-600 hover:text-white transition">Sign Out</button> :
                    <button onClick={googleSignIn} className="navItem mr-5 lg:ml-36">Sign In</button> 
                    }
                    {/* <Link prefetch as='/camShop/cart' onClick={()=>setVisible(true)} className={visible ? 'cart-ico-1 my-auto cart-ico' : 'cart-ico-2  my-auto cart-ico' } href='/camShop/cart' ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
